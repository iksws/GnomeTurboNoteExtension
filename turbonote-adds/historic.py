...
class MyWindow(Gtk.Window):
    def __init__(self):
        ...
        if config_note.getColorRevertTitle():
            self.removeimg.set_from_file("/usr/share/gnome-shell/extensions/turbonote@iksws.com.br/icons/ic_action_storage" + config_note.getColorOver() + ".png")      
        else:
        ...
        if config_note.getColorRevertTitle():
            self.removeallimg.set_from_file("/usr/share/gnome-shell/extensions/turbonote@iksws.com.br/icons/ic_action_storage_all" + config_note.getColorOver() + ".png")        
        else:               
        ...
        if config_note.getColorRevertTitle():
            self.sending.set_from_file("/usr/share/gnome-shell/extensions/turbonote@iksws.com.br/icons/ic_action_send_now_all" + config_note.getColorOver() + ".png")        
        else:
            self.sending.set_from_file("/usr/share/gnome-shell/extensions/turbonote@iksws.com.br/icons/ic_action_send_now_all" + config_note.getColor() + ".png")        
