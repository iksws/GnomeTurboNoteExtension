...
class HeaderBarWindow(Gtk.Window):
    ...
    def create_textview(self,box2,hb):
		...
		if config_note.getColorRevertTitle():
			self.enabletitle.set_from_file("/usr/share/gnome-shell/extensions/turbonote@iksws.com.br/icons/ic_action_labels" + config_note.getColorOver() + ".png")		
		else:
		...
		if config_note.getColorRevertTitle():
			self.settingsimg.set_from_file("/usr/share/gnome-shell/extensions/turbonote@iksws.com.br/icons/ic_action_settings" + config_note.getColorOver() + ".png")		
		else:
